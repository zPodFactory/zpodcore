...
from zpodengine.zpod_component_add.zpod_component_add_5_extra_post_scripts import (
    zpod_component_add_extra_post_scripts,
)
...
def zpod_component_add(
    *,
    ...
    extra_post_scripts = zpod_component_add_extra_post_scripts.with_options(
        **options(name="extra_postscripts"),
    ).submit(
        zpod_component_id=zpod_component.result().id,
