...
class ZpodsNetworksGetAll:
    ...
    ) -> Optional[Union[HTTPValidationError, List["ZpodNetworkView"]]]:
    ...
    def _build_response(
        self, *, response: httpx.Response
    ) -> Response[Union[HTTPValidationError, List["ZpodNetworkView"]]]:
        return Response(
    ...
    def sync(
        ...
        Returns:
            Union[HTTPValidationError, List['ZpodNetworkView']]
        """
