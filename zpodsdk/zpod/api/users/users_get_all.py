...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["UserView"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["UserView"]]:
    return Response(
